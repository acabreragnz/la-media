...
// import { scrapeBcuRates } from './bcu-scraper.mts' // Temporalmente deshabilitado - requiere más pruebas
...
export const BANK_SCRAPER_MAP: Record<BankId, () => Promise<ExchangeRate>> = {
  ...
  // bcu: scrapeBcuRates, // Temporalmente deshabilitado - requiere más pruebas
  bcu: async () => { throw new Error('BCU scraper temporarily disabled') },
...
export function getActiveBanks(): BankId[] {
  return ['brou', 'itau'] // BCU temporalmente deshabilitado - requiere más pruebas
}
